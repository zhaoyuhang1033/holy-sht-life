import { Talent, TurnData } from '../types';

// 天赋库
export const talentPool: Talent[] = [
  { id: 't1', name: '社恐体质', desc: '你天生害怕人群，情商-2，但智商+3', quality: 'blue' },
  { id: 't2', name: '富二代', desc: '投胎技术过硬，家境+5', quality: 'gold' },
  { id: 't3', name: '学霸光环', desc: '智商+4，但体质-1', quality: 'purple' },
  { id: 't4', name: '网瘾少年', desc: '沉迷网络，智商-1，情商-2，魔幻度+3', quality: 'black' },
  { id: 't5', name: '天生神力', desc: '体质+3，智商-1', quality: 'blue' },
  { id: 't6', name: '社交牛逼症', desc: '情商+4，到哪都是人群焦点', quality: 'purple' },
  { id: 't7', name: '克苏鲁之子', desc: '魔幻度+5，智商+2，但容易遭遇怪事', quality: 'gold' },
  { id: 't8', name: '倒霉蛋', desc: '运气极差，所有属性-1，但魔幻度+4', quality: 'black' },
  { id: 't9', name: '中产阶级', desc: '家境+3，情商+1', quality: 'blue' },
  { id: 't10', name: '天选打工人', desc: '体质+2，情商+1，注定996', quality: 'blue' },
  { id: 't11', name: '艺术家气质', desc: '情商+3，魔幻度+2，但家境-1', quality: 'purple' },
  { id: 't12', name: '赛博朋克', desc: '生在霓虹都市，魔幻度+3，智商+1', quality: 'purple' },
  { id: 't13', name: '孤儿', desc: '家境-3，但体质+2，智商+2', quality: 'black' },
  { id: 't14', name: '天生废物', desc: '所有属性-2，但魔幻度+6', quality: 'black' },
  { id: 't15', name: '命运之子', desc: '所有属性+2', quality: 'gold' },
  { id: 't16', name: '时间旅行者', desc: '你似乎经历过这一切，魔幻度+4', quality: 'gold' },
  { id: 't17', name: '社畜预备役', desc: '天生打工命，体质+1，情商+2', quality: 'blue' },
  { id: 't18', name: '二次元', desc: '沉迷动漫，智商+1，魔幻度+2，情商-2', quality: 'purple' },
  { id: 't19', name: '吃货', desc: '对美食有执念，体质+2，家境-1', quality: 'blue' },
  { id: 't20', name: '夜猫子', desc: '昼伏夜出，智商+2，体质-1，魔幻度+1', quality: 'purple' },
];

// Mock 剧情数据
const storyDatabase: Record<string, TurnData> = {
  START: {
    age: 0,
    story: '你降生在这个操蛋的世界。产房的霓虹灯闪烁着不祥的紫光，护士的眼睛似乎在发光。你感觉到命运的齿轮开始转动...',
    choices: [
      { id: 'C1_A', text: '大声哭闹，宣示存在' },
      { id: 'C1_B', text: '安静观察，先苟一波' },
      { id: 'C1_C', text: '尝试和护士对视' },
    ],
    attribute_changes: {},
    is_dead: false,
  },
  ...
  C2_A: {
    ...
    choices: [
      { id: 'C3_A', text: '忍辱负重，暗中发展' },
      { id: 'C3_B', text: '金盆洗手，专心学习' },
      { id: 'C3_C', text: '不服，继续刚' },
    ],
  ...
  C3_A: {
    ...
    choices: [
      { id: 'C4_A', text: '继续扩张势力' },
      { id: 'C4_B', text: '适可而止，准备中考' },
      { id: 'C4_C', text: '利用情报搞点小生意' },
    ],
  ...
  C4_A: {
    ...
    choices: [
      { id: 'DEATH_1', text: '硬刚到底' },
      { id: 'C5_A', text: '见好就收' },
      { id: 'C5_B', text: '转移阵地，去校外发展' },
    ],
  ...
  C5_A: {
    ...
    choices: [
      { id: 'END_1', text: '好好学习，准备考研' },
      { id: 'END_2', text: '创业，实现财富自由' },
      { id: 'END_3', text: '躺平，享受生活' },
    ],
...
// 随机获取天赋
export function getRandomTalents(count: number = 10): Talent[] {
  const shuffled = [...talentPool].sort(() => Math.random() - 0.5);
  return shuffled.slice(0, count);
}

// 获取剧情数据
export function getStoryData(storyId: string): TurnData {
  return storyDatabase[storyId] || storyDatabase.START;
}
